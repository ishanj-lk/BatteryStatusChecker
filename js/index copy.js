...
$('.bt2').click(function() {
    let precent = 47.5
    descriptionHead.text(`${precent}%`);
    descriptionBody.text(`1. ${(currentbattery/100)*precent}Wh Remaining for safe use`);
    descriptionBody2.text(`2. ${currentbattery-(currentbattery/100)*precent}Wh used`);
    descriptionBody3.text(`3. Another ${((currentbattery/100)*precent)/2}Wh Remaining for unsafe use`);
});
